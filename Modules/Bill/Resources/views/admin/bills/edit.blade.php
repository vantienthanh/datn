...
@section('content-header')
    <h1>
        {{ trans('bill::bills.title.edit bill') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.bill.bill.index') }}">{{ trans('bill::bills.title.bills') }}</a></li>
        <li class="active">{{ trans('bill::bills.title.edit bill') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.bill.bill.update', $bill->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('bill::admin.bills.partials.edit-fields', ['lang' => $locale])
                        </div>
                    @endforeach
